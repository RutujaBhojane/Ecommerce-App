...
const onSubmit = (data: ProductFormData) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="p-4 border rounded mb-6 max-w-md">
      ...
      <div className="mb-3">
        <input {...register('stock')} placeholder="Stock" className="w-full border p-2 rounded" />
